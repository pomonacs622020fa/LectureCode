...
public class CardDealerArrayList{
	...
	public CardDealerArrayList(int numDecks){
	...
	public static void printDeck(CardDealerArrayList dealer){
		int count = 0;
	...
	public static void main(String[] args){
		CardDealerArrayList dealer = new CardDealerArrayList(1);
		printDeck(dealer);
		dealer.addDeck();
		printDeck(dealer);
	}
